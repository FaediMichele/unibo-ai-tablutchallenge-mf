...
white = 1
king = 2
distance_from_excapes =[[0, 0, 1, 2, 1, 0, 0],
                        [0, 1, 2, 3, 2, 1, 0],
                        [1, 2, 3, 4, 3, 2, 1],
                        [2, 3, 4, 5, 4, 3, 2],
                        [1, 2, 3, 4, 3, 2, 1],
...
def heuristic( state: State, player: int, min_max: bool) -> float:
    ...
    king_value = (enemy_adjacent_king if king_pos == (3, 3) else # castle
                  enemy_adjacent_king * 2 if king_pos not in [(2, 3), (3, 2), (4, 3), (3, 4)] else # near the castle
