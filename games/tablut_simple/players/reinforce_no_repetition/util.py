from games.tablut_simple.game import State, Action, Game
from typing import Callable, Any
from collections import defaultdict
import tensorflow as tf

SAVE_ITERATIONS = [1, 10, 25, 50, 100, 300, 500, 1000, 2000, 3000, 4000, 5000, 7500, 10000]
...
def boolean_mask_from_coordinates(batch_action_list: list[list[tuple[int,int,int]]]) -> tf.Tensor:
    ...
    mask = tf.zeros((batch_size, 7, 7, 14), dtype=tf.bool)
    mask = [
        [[[False for _ in range(14)] for _ in range(7)] for _ in range(7)]
